...
const $CONTAINS_CLASS = (el, cls) => el.classList.contains(cls);
const $REMOVE_CLASS = (el, cls) => el.classList.remove(cls);
...
class App {
  constructor() {
    this.isLoaded = $CONTAINS_CLASS($BODY, "active");
  }

  loadApp() {
    setTimeout(() => {
      this.isLoaded
        ? $REMOVE_CLASS($BODY, "active")
        : $ADD_CLASS($BODY, "active");
...
const ctx =
  ...
  (() => {
    throw new Error("Oops! Canvas is not existed!");
  });
...
const startGame = () => {
  ...
  appleImage.src = "pic/texture/apple.png";
  ...
  class Snake {
    constructor() {
      ...
      this.headUp.src = "pic/texture/head_up.png";
      this.headDown = new Image();
      this.headDown.src = "pic/texture/head_down.png";
      this.headRight = new Image();
      this.headRight.src = "pic/texture/head_right.png";
      this.headLeft = new Image();
      this.headLeft.src = "pic/texture/head_left.png";

      this.tailUp = new Image();
      this.tailUp.src = "pic/texture/tail_up.png";
      this.tailDown = new Image();
      this.tailDown.src = "pic/texture/tail_down.png";
      this.tailRight = new Image();
      this.tailRight.src = "pic/texture/tail_right.png";
      this.tailLeft = new Image();
      this.tailLeft.src = "pic/texture/tail_left.png";

      this.bodyVertical = new Image();
      this.bodyVertical.src = "pic/texture/body_vertical.png";
      this.bodyHorizontal = new Image();
      this.bodyHorizontal.src = "pic/texture/body_horizontal.png";

      this.bodyTR = new Image();
      this.bodyTR.src = "pic/texture/body_tr.png";
      this.bodyTL = new Image();
      this.bodyTL.src = "pic/texture/body_tl.png";
      this.bodyBR = new Image();
      this.bodyBR.src = "pic/texture/body_br.png";
      this.bodyBL = new Image();
      this.bodyBL.src = "pic/texture/body_bl.png";

      this.crunchSound = new Audio("sound/crunch.wav");
    }
